...
@ExtendWith(MockitoExtension.class)
 class UserServiceTest {
    ...
    void shouldReturnUserWhenGetUserByEmailInvoked() throws Exception {
        when(mockedUserRepository.findByEmail("abhijeet@gmail.com")).thenReturn(Optional.of(getSampleUser()));
        when(modelDtoConverter.entityToDtoForEmail(any(User.class))).thenReturn(getSampleEmailDtoUser());

        UserEmailDto user = userService.getUserDetailsByEmail("abhijeet@gmail.com");
    ...
    public User getSampleUser(){
        ...
        user.setDateOfBirth("1996-02-02");
        user.setAddress("Pune");
        user.setPhoneNumber("9579487422");
    ...
    public List<User> getSampleUsers(){
        ...
        user.setLastName("pawar");
        user.setEmail("abhijeet@gmail.com");
        sampleUser.setFirstName("abhi");
        sampleUser.setLastName("pawar");
        sampleUser.setEmail("abhijeet@gmail.com");
        sampleUser.setPassword("13456");
        sampleUser.setGender(Gender.MALE);
        sampleUser.setDateOfBirth("1996-02-02");
        sampleUser.setAddress("Pune");
        sampleUser.setPhoneNumber("9579487422");
